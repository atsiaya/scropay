  ...
  async function handleSubmit() {
    ...
    try {
      const res = await fetch("/api/kyc", {
        ...
        body: JSON.stringify({ fullName, idNumber, direction, fiat, asset, network }),
      });
      ...
      if (data.status === "verified") {
        ...
        const q = new URLSearchParams({ direction, fiat: String(fiat), asset: String(asset), network });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-[var(--color-line)] bg-white/70 p-5 shadow-[0_1px_0_var(--color-line)]">
          ...
          <p className="mt-1 text-sm text-[var(--color-ink)]/60">
            ...
            {direction === "buy" ? "buying" : "selling"}. We&apos;ll check
            these details — if you&apos;ve verified with us before under
            this ID, you&apos;ll go straight through; otherwise you&apos;ll
