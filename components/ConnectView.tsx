...
/**
 * This route is the buy flow's step 2 of 3 (connect a wallet to receive
 * USDT) — step 3 is /buy/pay, the M-Pesa STK push. Sell has its own
 * two-step flow — /sell/payout then /sell/deposit — since "receive
 * M-Pesa, send USDT to us" is a different shape than "receive USDT, pay
 * with M-Pesa". See RampCard's handleContinue for the branch.
 */
